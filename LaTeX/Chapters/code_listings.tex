...
\lstinputlisting[language=Python, caption=Performing TWAP Simulation]{Code/twap_code}\label{code:twap_code}
\end{singlespacing}
\subsection{VWAP Testing}
\begin{singlespacing}
\lstinputlisting[language=Python, caption=Performing VWAP Simulation]{Code/vwap_code}\label{code:vwap_code}
\end{singlespacing}